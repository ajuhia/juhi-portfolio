      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block">
            <h2 className="text-4xl sm:text-5xl font-bold text-earth-brown-900 mb-4 font-poppins">About Me</h2>
        ...
        <div className="flex justify-center">
          <div className="animate-fade-in max-w-6xl">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300">
              <p className="text-lg text-earth-brown-700 leading-relaxed font-poppins text-justify">
                ...
                <br /><br />
                Right now, I'm diving deeper into the world of AI—curious, excited, and always learning. If you're passionate about <span className="font-semibold text-warm-beige-700">analytics, responsible tech, or building tools that make a difference</span>, let's connect. 🚀
              </p>
            </div>
          </div>
        </div>
