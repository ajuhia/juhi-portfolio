  ...
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_25%_25%,rgba(128,0,32,0.1),transparent_50%)]"></div>
        <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_75%_75%,rgba(70,130,180,0.1),transparent_50%)]"></div>
      </div>
          ...
          <div className="animate-fade-in order-1 lg:order-2">
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300">
              <p className="text-lg text-slate-700 leading-relaxed font-poppins">
                Hey there! 👋 I'm <span className="font-semibold text-maroon-600">Juhi</span>, and I'm absolutely fascinated by the magic that happens when data meets creativity. You know that feeling when you discover a hidden pattern in seemingly random numbers? That's my daily dose of excitement!
                <br /><br />
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="text-center p-6 bg-gradient-to-br from-maroon-50 to-maroon-100/50 rounded-xl border border-maroon-200">
                  <div className="text-2xl font-bold text-maroon-600">5+</div>
                  <div className="text-sm text-slate-600">Years Experience</div>
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-steel-blue-50 to-steel-blue-100/50 rounded-xl border border-steel-blue-200">
                  <div className="text-2xl font-bold text-steel-blue-600">15+</div>
